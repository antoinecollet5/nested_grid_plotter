...
Please report defects using the `GitHub Issue Tracker <https://github.com/antoinecollet5/nested_grid_plotter/issues>`_.
...
- Information about your environment (OS, Python version, nested_grid_plotter version)
...
`GitHub Issue Tracker <https://github.com/antoinecollet5/nested_grid_plotter/issues>`_.
...
nested_grid_plotter documentation, in docstrings, tutorials, or external resources such as blog posts and articles.
...
`labels <https://github.com/antoinecollet5/nested_grid_plotter/labels>`_ and milestones.
...
1. Fork the `nested_grid_plotter` repository on GitHub.

2. Clone your fork locally::

    $ git clone git@github.com:your_username/nested_grid_plotter.git
    $ cd nested_grid_plotter
